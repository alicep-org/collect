 ...
 * @see     LinkedHashSet
 */
public class NoScanDuringCompactionArraySet<E> extends AbstractSet<E> implements Serializable {
  ...
  public static <T> Collector<T, ?, Set<T>> toArraySet() {
    return Collector.of(NoScanDuringCompactionArraySet::new, Set::add, (left, right) -> { left.addAll(right); return left; });
  }

  /**
   * Constructs an empty set with an initial capacity of ten.
   */
  public NoScanDuringCompactionArraySet() {
    data = null;
    lookup = null;
    head = -1;
  }
   ...
   */
  public static <E> NoScanDuringCompactionArraySet<E> withInitialCapacity(int initialCapacity) {
    return new NoScanDuringCompactionArraySet<>(initialCapacity);
  }
   ...
   */
  public NoScanDuringCompactionArraySet(Collection<? extends E> elements) {
    this(elements.size());
    addAll(elements);
  }

  private NoScanDuringCompactionArraySet(int initialCapacity) {
